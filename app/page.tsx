...
export default function Home() {
  ...
  motto: "Code. Learn. Grow."
      ...
      {/* Contact */} <section
        id="contact"
        className="bg-purple-50 py-16 px-4 sm:px-6 lg:px-20 text-center"
      >
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-purple-800">
          Contact Us
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="text-left space-y-4 text-sm sm:text-base">
            <p>
              <strong>Address:</strong> F-2, Chandaka Industrial Estate
              <br />
            ...
            <p>
              <strong>Email:</strong> contact@evolvecodelink.com
            </p>

            {/* Logo below contact details */}
            <div className="pt-4">
              <img
      ...
      <footer className="bg-purple-700 text-white py-8 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-sm opacity-80">
              We specialize in building scalable, user-friendly, and impactful digital
